...
          
          // GANTI ALERT dengan showToast (SUCCESS)
...
        }
      } else {
        // GANTI ALERT dengan showToast (ERROR)
        showToast('Gagal: ' + (data.message || 'Terjadi kesalahan'), 'error');
      }
    } catch (error) {
      console.error('Error:', error);
      // GANTI ALERT dengan showToast (ERROR)
      showToast('Terjadi kesalahan koneksi ke server. Pastikan Backend berjalan.', 'error');
    } finally {
      setLoading(false);
    }
  };
